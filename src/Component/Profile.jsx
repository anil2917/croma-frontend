...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const usepro = await axios
      .post("http://localhost:8080/Profile", profiledata)
      .then((res) => {
        console.log(res);
      });
  };
  ...
  return (
      <div style={{width:"1"}}className="w-full  bg-black p-4 sm:p-6 rounded-2xl bg-black text-white shadow-lg border-white-800 border w-[100%]">
