...
function TV() {
      ...
      const filterItems = ()=>{
        ...
        const filterd = products.filter((item)=>item.category == "tv")
...
<div className="bg-black w-full flex flex-wrap justify-center items-center">
  {filterData.map((item) => {
       return             <div className="lg:w-[29%] w-[80%] lg:h-[470px] md:w-[40%] flex md:flex-col lg:flex-col justify-center items-center border-b-[0.8px] py-5 border-amber-50 m-2  my-3">
